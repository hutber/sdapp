...
//                });
            ...
            main:function(myself){
                ...
                if(myself.hasClass('required') || typeof myself.attr('required')!=="undefined") {
                    ...
                    if(form.validation.errorMe(myself)===0 && myself.hasClass('server') && form.ajaxEvents.ajaxTimer !== null){
